...
---------------------------------------------------------------------------------\n'),
                ...
                O = "E" -> menuPacienteEmergencia, utils:mensagemEspera, menuPaciente(ID);
                O = "S" -> tty_clear, main;
...
menuPacienteBuscarEspecialidadesUbs :- prompt('Id da UBS > ', I), 
...
leituraConsultaLaudoEspecifico :- prompt('ID do Laudo > ', IDL),
